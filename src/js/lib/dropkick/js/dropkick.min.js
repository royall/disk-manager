!function () {
    ...
    var n, a = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), o = e.parent !== e.self && location.host === parent.location.host, r = -1 !== navigator.appVersion.indexOf("MSIE"), l = function (s, i) {
        var n, a;
        ...
        hasClass: function (e, t) {
            ...
            var i = s.getBoundingClientRect() || {
                    top: 0,
                    left: 0
                }, n = t.documentElement, a = r ? n.scrollTop : e.pageYOffset, o = r ? n.scrollLeft : e.pageXOffset;
    ...
    return l.cache = {}, l.uid = 0, l.prototype = {
        add: function (e, s) {
            ...
            return o = r ? c.offset(d).top - t.documentElement.scrollTop : c.offset(d).top - e.scrollY, l = e.innerHeight - (o + d.offsetHeight), this.isOpen || this.multiple ? !1 : (h.style.display = "block", s = h.offsetHeight, h.style.display = "", i = o > s, n = l > s, a = i && !n && 0 ? "-up" : "-down", this.isOpen = !0, c.addClass(d, "dk-select-open" + a), h.setAttribute("aria-expanded", "true"), this._scrollTo(this.options.length - 1), this._scrollTo(this.selectedIndex), void this.data.settings.open.call(this))
